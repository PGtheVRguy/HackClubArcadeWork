...
namespace SubnauticaKnifeAttemp2
{
    // TODO Review this file and update to your own requirements.

    [BepInPlugin(MyGUID, PluginName, VersionString)]
    public class SubnauticaKnifeAttemp2Plugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // 1.0.0
        private const string MyGUID = "com.sapel.SubnauticaKnifeAttemp2";
        private const string PluginName = "SubnauticaKnifeAttemp2";
        ...
        // e.g.
        // float myFloat = SubnauticaKnifeAttemp2Plugin.FloatExample.Value;
        ...
        private void Awake()
        {
            ...
            // .e.g.
            // SubnauticaKnifeAttemp2Plugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (SubnauticaKnifeAttemp2Plugin.KeyboardShortcutExample.Value.IsDown())
            {
