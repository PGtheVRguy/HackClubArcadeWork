...
namespace SubnauticaKnifeAttemp2.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            SubnauticaKnifeAttemp2Plugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            SubnauticaKnifeAttemp2Plugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}