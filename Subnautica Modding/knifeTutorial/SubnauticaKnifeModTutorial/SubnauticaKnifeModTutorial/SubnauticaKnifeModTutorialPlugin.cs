...
namespace SubnauticaKnifeModTutorial
{
    // TODO Review this file and update to your own requirements.

    [BepInPlugin(MyGUID, PluginName, VersionString)]
    public class SubnauticaKnifeModTutorialPlugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // 1.0.0
        private const string MyGUID = "com.PGtheVRguy.SubnauticaTutorial";
        private const string PluginName = "SubnauticaKnifeModTutorial";
        ...
        private void Awake()
        {
            ...
            KnifeDamage = Config.Bind("General",    // The section under which the option is shown
                KnifeDamageKey,                            // The key of the configuration option
                1.0f,                            // The default value
                new ConfigDescription("The damage of the knife.",         // Description that appears in Configuration Manager
                    new AcceptableValueRange<float>(0.0f, 10000.0f)));     // Acceptable range, enabled slider and validation in Configuration Manager
            ...
            // .e.g.
            // SubnauticaKnifeModTutorialPlugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (SubnauticaKnifeModTutorialPlugin.KeyboardShortcutExample.Value.IsDown())
            {
